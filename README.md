...
| Given two integers, determine if their sum would be integer overflow.| [integerOverflow.cpp](bit_manipulation/integerOverflow.cpp)|
...
| Problem 1-3 : Edition 6: URLify: Replace all the spaces in a string with '%20'. Preferably Inplace |[1-3-URLify.cpp](cracking_the_coding_interview_problems/1-3-URLify.cpp)|
...
| Find next permutation of a given string, ie. rearrange the given string such a way that is next lexicographically greater string than given string | [next_permutation.cpp](string_problems/next_permutation.cpp)|
...
| Given an array of repeating/non-repeating integeres, determine the first non-repeating int in this array | [first_non_repeating_int.cpp](common_ds_algo_problems/first_non_repeating_int.cpp)|
